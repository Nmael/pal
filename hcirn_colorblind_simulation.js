/*
Adapted from https://github.com/MaPePeR/jsColorblindSimulator/blob/master/hcirn_colorblind_simulation.js
...
function blindMK(rgb,t) {
    ...
    return ({r: inversePow(sr), g: inversePow(sg), b: inversePow(sb)});
...
function monochrome(r) {
    var z = Math.round(r.r * 0.299 + r.g * 0.587 + r.b * 0.114);
    return ({r: z, g: z, b: z});
}
